...
import { MongoCredentials, MONGO_CONNECTION_TYPE } from './src/config/db/credentials/MongoCredentials.js';
...
export { MongoCredentials, MONGO_CONNECTION_TYPE, BitcoinNetwork, IConfig, ConfigBase, ConfigManager } 
